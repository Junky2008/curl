...
#define CURLURL_DEFAULT_PORT (1<<0)       /* return default port number (only
                                             works for schemes this libcurl
                                             supports) */
 ...
 */
CURL_EXTERN CURLUcode curl_url(const char *URL, CURLURL **urlhandle,
                               unsigned int flags);
